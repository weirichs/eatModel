...
\description{
  ...
  \itemize{
    ...
    \item \code{\link{getResults}} needs the output generated by \code{\link{runModel}} and re-collects all created
          ...
          used for analysis. Strictly speaking, \code{\link{getResults}} is'nt necessary, i.e. the user is free
    ...
    \item \code{\link{prepRep}} needs the output generated by \code{\link{transformToBista}}. The funtion
