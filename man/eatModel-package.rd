...
\description{
  ...
  \itemize{
    \item \code{\link{splitModels}} is only necessary if the user wants to estimate several IRT models in
          ...
          or if one (unidimensional) model should be fitted separately for several domains, say listening
          ...
          and estimated, calling \code{splitModels} is not necessary may be skipped. Start directly with
...
Type: \tab Package\cr
Version: \tab 0.7.39\cr
Date: \tab 2021-10-20\cr
License: \tab GPL(>=2)
}
}
\author{
